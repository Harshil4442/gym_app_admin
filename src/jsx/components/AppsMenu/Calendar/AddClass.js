...
class AddClass extends Component {
    ...
    deleteEvent = async (deletedata) => {
        try {
            await axios.delete(`http://localhost:5000/api/deleteevent`, { data: deletedata });
            this.fetchEvents();
    ...
    saveEventToServer = async (updatedEvent) => {
        try {
            const response = await axios.post(' http://localhost:5000/api/saveEvent', updatedEvent);
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <div id="external-events">
                                    ...
                                    <div className="fc-event external-event light btn-primary" title="My Event" data="3" onClick={() => this.eventClick({ title: "My Event" })}>
                                        <i className="fa fa-move" /><span>My Event</span>
                                    </div>
                                    <div className="fc-event external-event light btn-primary" title="Meet Manager" data="3" onClick={() => this.eventClick({ title: "Meet Manager" })}>
                                        <i className="fa fa-move" /><span>Meet Manager</span>
                                    </div>
                                    <div className="fc-event external-event light btn-primary" title="Create New Theme" data="3" onClick={() => this.eventClick({ title: "Create New Theme" })}>
                                        <i className="fa fa-move" /><span>Create New Theme</span>
                                    </div>
                                    <div className="fc-event external-event light btn-primary" title="Project Launch" data="3" onClick={() => this.eventClick({ title: "Project Launch" })}>
                                        <i className="fa fa-move" /><span>Project Launch</span>
                                    </div>
                                    <div className="fc-event external-event light btn-primary" title="Meeting" data="3" onClick={() => this.eventClick({ title: "Meeting" })}>
                                        <i className="fa fa-move" /><span>Meeting</span>
                                    </div>
